...
- PR #555 base=chore/w0-engineering-gate (NEMERGE do main)
- Evidence: lanes/B/{report,judge-output,result}, docs/reports/2026-09-15-lane-b-task-0101.md
### Rozpracované / Pending
- W3 scorecard — čaká na Founder prompt
- Lane A #554 / Lane C #553 stack merge podľa Founder
### Kľúčové súbory zmenené
- apps/crm/scripts/bus-validate.mjs + bus-validate-baseline.json
- apps/crm/scripts/ledger-report.mjs
- apps/crm/src/lib/ai/prompt-guard.ts + rescue-message.ts wire
### Ďalší krok
Founder pripraví W3 — záverečný report so scorecardom.
