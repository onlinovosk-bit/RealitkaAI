...
- **Kateg�ria:** Strategic Bet (klasifik�cia v2) � timebox ~3 dni � promote / re-bet / kill
...
- **Uzly dnes:** A1 Architecture Guardian � A2 Str�?ca vetiev � A3 Rann� brief (F�za 1 read-only)
- **Zak�zan�:** portal scrape � auto-deploy � prod DELETE � CREDITS_ENFORCEMENT on � merge #356?#366 nie je s�?as?ou tohto bal�ka
- **Review / kill d�tum:** **2026-09-08** (ADR + 30d metriky); prv� kill kontrola **2026-08-08**

### ADR-001 ? Orchestr�tor a? pri piatom uzle
Piaty uzol = orchestr�tor. Do ?tyroch sa reporty ?�taj� jednotlivo. Rann� brief je reportovacia vrstva, nie ?tvrt� ?feature? uzol.

### ADR-002 ? Vstupn� br�na
Ka?d� uzol m� vstupn� br�nu. Uzol bez br�ny sa nestavia.

### ADR-003 ? Vrstva 4: navrhova?, nestava?
Vrstva 4 smie navrhova?, prioritizova?, odhadova? n�vratnos? a pripravi? PR. Nikdy commit, merge ani deploy bez ?loveka.

### ADR-004 ? Dvojit� od�vodnenie (v�chodisko, nie z�kon)
Nov� uzol vy?aduje technick� **aj** obchodn� od�vodnenie. Ani jedno samo nesta?�. Predvolen� prahy (4. uzol: +10 osloven�ch; orchestr�tor: 3. platiaci; Center: 5 platiacich) s� **v�chodisko**; odch�lka je povolen� so zap�san�m d�vodom a d�tumom rev�zie v tomto s�bore. Neuznan� d�vod: ?bolo by to zauj�mav� postavi?.?

### ADR-005 ? ?ivotn� cyklus uzla
N�VRH ? BE?� ? VYHODNOTENIE (30/90 dn�) ? PONECHA? | ZL�?I? | VYPN�?. Vypnut� uzol sa **nema?e** ? zost�va v repe s d�tumom a d�vodom. Sp�??a?e vypnutia: 30 dn� bez verdiktu v `docs/audit/nodes-value.jsonl` � 30 dn� bez akcie � trvalo ?erven� 14 dn� � nahraden� � prah splnen� natrvalo.

### Kill krit�rium
Ak 2026-08-08 nebude founder vedie? poveda?, ?e reporty ?�tal p�? r�n po sebe, vypn�? v?etky tri a nestava? ?tvrt�.

- **Verdikt schema:** `verdict ? { konal | vedel | zbyto?n� }` ? append do `docs/audit/nodes-value.jsonl`
