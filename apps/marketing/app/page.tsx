      ...
      <div className="section" style={{ maxWidth: 1300 }}>
        ...
        <div className="pricing-grid-full">
          ...
          <div className="price-card featured visible">
            ...
            <div className="expert-bonus" style={{ background: 'rgba(255,255,255,.06)', borderColor: '#38BDF8' }}><div className="expert-bonus-text" style={{ color: 'rgba(255,255,255,.65)' }}>Automatický obsahový magnet — klient dostane personalizovaný market report bez toho aby o to žiadal. Maklér vyzerá ako expert, bez práce.</div></div>
