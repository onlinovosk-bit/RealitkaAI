...
`main` má branch protection: **Require branches to be up to date before merging** + required check `Lint, test, build`. PR postavený na starom `main` sa pred merge musí rebase-núť — sémantické konflikty sa ukážu v CI, nie po merge.
