...
export const TENANT_TABLES: TenantTableDef[] = [
  ...
  { table: "guardian_findings", scope: "agency_id", pk: "id", domain: "leads" },
  { table: "moat_ai_recommendations", scope: "agency_id", pk: "id", domain: "deals" },
  { table: "valuation_estimates", scope: "agency_id", pk: "id", domain: "leads" },
  ...
  { table: "enrichment_log", scope: "agency_id", pk: "id", domain: "documents" },
  {
    table: "agency_signals",
    scope: "agency_id",
    pk: "id",
    domain: "agencies",
...
export const PLATFORM_TABLES = [
  ...
  { table: "bsm_reforma_leads", note: "Capture route retired 2026-09-25; service_role only" },
