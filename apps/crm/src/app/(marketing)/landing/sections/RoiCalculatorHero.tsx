    ...
    <section className="bg-slate-950 pb-10">
      <div className="mx-auto max-w-6xl px-6">
        <div className="rounded-3xl border border-cyan-400/20 bg-cyan-500/[0.06] p-6 md:p-8">
          <div className="mb-6">
            <p className="text-xs uppercase tracking-[0.25em] text-cyan-300">ROI kalkulačka</p>
            <h3 className="mt-2 text-2xl font-extrabold text-slate-100" style={{ fontFamily: 'var(--font-syne)' }}>
              Koľko mesačne uniká bez AI follow-upu?
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="space-y-4 lg:col-span-2">
              <label className="block">
                <span className="mb-1 block text-xs text-slate-400">Leady / mesiac: {leadsPerMonth}</span>
              ...
              <label className="block">
                <span className="mb-1 block text-xs text-slate-400">Deal rate (%): {dealRate}</span>
