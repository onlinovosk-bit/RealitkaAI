...
export type DashboardPageClientProps = {
  /** SSR: súhrn zo server Supabase klienta (RLS má platný JWT z cookies). Vynechané → widget načíta cez browser. */
  initialPropertiesSummary?: PropertiesSummary;
};
  ...
  return (
    <div className="p-3 md:p-6" style={{ minHeight: "100%" }} id="actions">
      <div className="mx-auto max-w-6xl">
        ...
        <section>
          <PropertiesSummaryWidget serverSummary={initialPropertiesSummary} />
        </section>
      </div>
    </div>
  );
