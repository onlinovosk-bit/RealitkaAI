      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 p-12 md:grid-cols-3">
        ...
        <div className="space-y-6">
          <div className="rounded-[2.5rem] border border-blue-500/20 bg-gradient-to-br from-blue-600/20 to-transparent p-8 shadow-2xl">
            ...
            <ul className="mb-8 space-y-3 text-[10px] font-bold uppercase tracking-widest text-slate-400">
            ...
            <button className="w-full rounded-2xl bg-blue-600 py-4 text-xs font-black text-white transition-all hover:bg-blue-500">
              REQUEST API KEY
            </button>
          </div>
        </div>
