...
import { getTracedOpenAIClient } from "@/lib/langfuse/clients";
...
export async function callOpenAI(params: {
  ...
  const execute = async (): Promise<CallOpenAIResult> => {
  ...
  return withAiTraceContext(params.trace, params.tag, execute);
}
