...
- **prompts/agents/AGENT_STANDARD.md** — 5-časový prompt štandard, 7 agentov
- **prompts/ai/MASTER_PROMPT.md** — L99 Multi-Agent OS (Orchestrator + 4 Specialist Agents, RACI, HubSpot+GA4, A/B, MindStudio)
