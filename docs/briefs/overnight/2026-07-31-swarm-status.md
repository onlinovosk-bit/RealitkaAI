...
| **#343** | `swarm/w3a-system-agency` | refactor(usage): SYSTEM_USAGE_AGENCY_ID oddelené od Smolka (Wave 3A) | **OPEN** | https://github.com/onlinovosk-bit/RealitkaAI/pull/343 |
...
| `w3a-system-agency` | `swarm/w3a-system-agency` | 3A | usage-metrics + call sites | **in PR** (#343) |
...
| `task-1785529546512-52gc2j` | 3A | **in PR** (#343) |
...
Blocked na merge Vlny 3 (#343). Po merge spusti 4A (regresie) + 4B (demo readiness).
...
Hive ID `hive-1785529619368` — historický bloker: Claude Code CLI not in PATH. Vlny 1–2 doručené cez PR #336–#340. Vlna 3 cez PR #343.
