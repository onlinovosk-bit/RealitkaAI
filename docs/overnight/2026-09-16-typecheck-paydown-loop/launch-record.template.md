...
| `pr_554_merged` | _prázdne_ | **`true` je podmienka štartu** — bez Judge a ratchetu slučka nemá bránu |
| `pr_555_merged` | _prázdne_ | `false` je v poriadku — vtedy sa vynechá acceptance `T4` |
