...
**Root cause:** Sumár bol generovaný z git log subject lines bez dôslednej kontroly čo je v `prompts/ai/MASTER_PROMPT_V3.md`. Commit s textom "Boris Cherny Engineering Discipline (8 standards)" bol prítomný, ale výstup ho nezahŕňal ako kľúčový míľnik.
...
**Mistake:** `prompts/ai/MASTER_PROMPT_V3.md` odkazoval na `docs/crm/tasks/todo.md` a `docs/crm/tasks/lessons.md` (BC-1, BC-3), ale tieto súbory neboli nikdy fyzicky vytvorené v repozitári.
...
**Rule:** Každý nový súbor, na ktorý odkazuje `prompts/ai/MASTER_PROMPT_V3.md` alebo `docs/progress.md`, musí byť fyzicky vytvorený v tom istom PR/commite ako dokument, ktorý naň odkazuje.
